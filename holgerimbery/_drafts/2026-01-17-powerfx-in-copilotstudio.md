...
* Control how topics communicate with each other, how state flows through the conversation, and how the agent flows orchestrate automation.
...
In this scenario, the agent receives an order number and wants to communicate an estimated delivery date.   
Step-by-step  
...
This example highlights why Power Fx is important: your agent performs deterministic date transformation without involving the LLM, ensuring accuracy and consistency.

## Understanding Variable Prefixes in Copilot Studio
Unlike Power Apps, variables in Copilot Studio require specific prefixes inside a Power Fx formula. 
