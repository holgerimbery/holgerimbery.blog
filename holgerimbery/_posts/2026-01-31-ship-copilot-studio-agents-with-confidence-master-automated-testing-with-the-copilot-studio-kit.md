...
### Test design
- [X] Identify top intents and critical flows; write Response/Topic/Attachment tests.   
- [X] Add Generative answers tests for non‑deterministic responses (with validation instructions and sample answers).  
- [X] Compose Multi‑turn scenarios for end‑to‑end paths; add Plan validation for generative orchestration. 

### Automation
- [X] Create test sets in Kit and (optionally) in Agent evaluation to complement coverage; export results to CSV for retention.    
