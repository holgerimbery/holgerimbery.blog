...
{: .note }
> **Related to**:
> Microsoft's Agent Evaluation GA announcement on March 31, 2026, update to [Testing Copilot Studio Agents: Copilot Studio Kit vs. Agent Evaluation (Preview)](https://holgerimbery.blog/testing-copilot-studio-agents-copilot-studio-kit-vs-agent-evaluation-preview)
