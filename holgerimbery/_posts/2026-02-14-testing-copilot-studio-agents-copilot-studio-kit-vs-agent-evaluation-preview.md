...
author: admin
slug: testing-copilot-studio-agents-copilot-studio-kit-vs-agent-evaluation-preview
canonical_url: https://holgerimbery.blog/testing-copilot-studio-agents-copilot-studio-kit-vs-agent-evaluation-preview
...
{: .note }
> updated version: [Testing Copilot Agents: When to Use Agent Evaluation vs. the Copilot Studio Kit](https://holgerimbery.blog/testing-copilot-agents-when-to-use-agent-evaluation-vs-the-copilot-studio-kit)
