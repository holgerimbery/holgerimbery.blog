...
{: .important }
I would suggest: keep instructions for what is true in *every* conversation, and move everything *situational* into Skills that the agent loads as needed—like a reference manual, checklist, runbook, or playbook.
